    ...
    <tr>
     ...
     <tr>
        <td width="10%" class="tableleft">所属约稿</td>
       	 ...
       	 <td>${pageFile.pf_mu_id>0?mu.mname:"暂无约稿信息"}</td>
    ...
    <tr>
        <td colspan="2">
			<center>
				...
				<c:if test="${pageFile.pf_mu_id==null }">
                <button type="button" class="btn btn-primary" name="editPageFile" id="editPageFile" onclick="javascript:window.location.href='<%=basePath%>PageFile_goUpdate.action?pageFile.pf_id=${pageFile.pf_id }'">编辑</button>
				</c:if>
			</center>
		</td>
    </tr>
