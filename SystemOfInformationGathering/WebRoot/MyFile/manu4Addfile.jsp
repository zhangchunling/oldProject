...
<html>
  ...
  <link rel="stylesheet" type="text/css" href="Css/bootstrap.css" />
    ...
    $(function () {       
		$('#save').click(function(){
			if(flag1&&flag2&&flag3&&$('#pf_mu_id').val()!=0){
...
<table class="table table-bordered table-hover definewidth m10">
    <tr>
     ...
     <tr>
        ...
        <td><input id="pf_style" type="text" name="pageFile.pf_style" id="pf_style" value="言情"/>
    ...
    <tr>
        ...
        <td > 
          <textarea  cols="60" name="pageFile.content"  style="width: 600px; height: 300px;"></textarea><div  style="color: red;font-size: 5px;float: right;" >*最少输入10个字符</div>
        </td>
        
    </tr>
     <tr>
        <td width="10%" class="tableleft" >约稿</td>
        <td>${mu.mname }---${mu.mbknum }</td>
    </tr>
    <tr>
        <td colspan="2">
			<center>
