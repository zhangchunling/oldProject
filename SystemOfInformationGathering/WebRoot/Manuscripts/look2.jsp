...
<table class="table table-bordered table-hover definewidth m10">
   ...
   <tr>
    ...
    <tr>
        <td colspan="2">
			<center>
				<button type="button" class="btn btn-success"  onclick="javascript:window.location.href='<%=basePath%>Manu_sub1Ok.action?pageFile.pf_mu_id=${pageFile.pf_mu_id }'">审核通过</button>
                <button type="button" class="btn btn-success" onclick="javascript:window.location.href='<%=basePath%>Manu_sub1No.action?pageFile.pf_id=${pageFile.pf_id }'">审核不通过</button>
